...
export default function Page() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-blue-600 to-blue-500 p-4 text-black">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="p-8">
                  {message && (
              <div
                className={`mt-2 text-center ${
                  message === "Registration successful!" ? "text-green-600" : "text-red-500"
                }`}
              >
                {message}
              </div>
